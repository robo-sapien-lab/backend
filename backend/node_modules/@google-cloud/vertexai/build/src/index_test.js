...
const StreamFunctions = require("./process_stream");
...
const TEST_SAFETY_RATINGS = [
    {
        ...
        threshold: content_1.HarmBlockThreshold.BLOCK_MEDIUM_AND_ABOVE,
    },
];
...
describe('VertexAI', () => {
    ...
    describe('generateContent', () => {
        it('aggregates citation metadata', async () => {
            ...
            expect((_a = resp.response.candidates[0].citationMetadata) === null || _a === void 0 ? void 0 : _a.citationSources.length)
